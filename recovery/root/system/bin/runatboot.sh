...
morph_into_non_dynamic() {
	...
	resetprop "ro.orangefox.variant" "dynamic-with-static-rom";
        ...
        # Disable Casefold support on 4.4
        resetprop external_storage.casefold.enabled 0
        resetprop external_storage.projid.enabled 0
        resetprop external_storage.sdcardfs.enabled 1
}
